import { useContext, useState, useEffect } from "react"; // ← ADDED useContext
import { useParams, useNavigate } from "react-router-dom";
import AppContext from "../Context/Context"; // ← ADDED THIS
import api from "../axios"; // FIXED: Import api instead of axios

const UpdateProduct = () => {
  const { id } = useParams();
  const navigate = useNavigate();
  const { addToCart, removeFromCart, refreshData } = useContext(AppContext); //ADDED
